...
{
    public partial class Frm_Buscar_ar : Form
    {
        public Frm_Buscar_ar()
        {
            InitializeComponent();
        }
        ...
        private void Selecciona_dgv()
        {
            ...
            {
               MisVariables_Buscar.v1Codigo_ar= Convert.ToInt32(Dgv_Listado.CurrentRow.Cells["codigo_ar"].Value);
               MisVariables_Buscar.v1Descripcion_ar= Convert.ToString(Dgv_Listado.CurrentRow.Cells["descripcion_ar"].Value) + "  |  "+
        ...
        private void Frm_Buscar_ar_Load(object sender, EventArgs e)
        {
            this.Mostrar("%");
        }
