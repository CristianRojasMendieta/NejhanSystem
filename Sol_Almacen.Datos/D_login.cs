...
namespace Sol_Almacen.Datos
{
    ...
    {
        public DataTable Acceder_us(int Ncodigo_si, string Cemail_us, string Cpassword_us)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@Ncodigo_si", SqlDbType.Int).Value = Ncodigo_si;
            ...
            try
            {
                ...
                if (Tabla.Rows.Count > 0)
                {
                    ...
                    mailService.sendMail(
                      subject: "Sistema de Almacen V1: Solicitud de recuperación de contraseña",
